...
// const primaryColor = "#00A8AB";
const primaryColor = "#00A8AB";
const primaryHoverColor = "#006666";
const secondaryColor = "#F4763B";
const secondaryHoverColor = "#A24E27";
const warningColor = "#ffad33";
const dangerColor = "#f44336";
const successColor = "#00acc1";
const infoColor = "#0053b3";
const errorColor = "#e60000";
const titleColor = "#332200";
const subtitleColor = "#42526e";
...
const title = {
  ...
  textDecoration: "none",
  fontWeight: "700",
  fontFamily: `"Open Sans", "Roboto Slab", "Nunito", serif`,
};
